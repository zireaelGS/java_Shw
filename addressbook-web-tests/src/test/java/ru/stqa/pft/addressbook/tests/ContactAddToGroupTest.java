...
public class ContactAddToGroupTest extends TestBase {
    ...
    public void testContactAddToGroup() {
        ...
        if (!contact.getGroups().isEmpty() && contact.getGroups().contains(group)) {
            ...
            assertThat(contact.getGroups().without(group), equalTo(app.db().contacts()
                    .stream().filter((c) -> c.getId() == contact.getId())
        ...
        assertThat(contact.getGroups().withAdded(group), equalTo(app.db().contacts().stream().
